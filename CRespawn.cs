...
public class CRespawn : MonoBehaviour
{
    ...
    void Start()
    {
        //Debug.Log(_spawnNumber.Length);
        //Debug.Log(_spawnNumber[0]);
        //Debug.Log(_spawnNumber[1]);
    ...
    public void RemoveMonster(int spawnID)
    {
        ...
        if (_deadMonsters == _monsters.Count)
        {
            ...
            if (!_isRespawn)
            {
                Crystal.SendMessage("RemoveFromWorld", SendMessageOptions.DontRequireReceiver);
