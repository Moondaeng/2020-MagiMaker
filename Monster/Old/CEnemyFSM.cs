...
public class CEnemyFSM : MonoBehaviour
{
    ...
    protected CMonstermeleeChecker AttackTrail1, AttackTrail2;         // 몬스터 기본 공격 Trail
    ...
    protected virtual void InitStat()
    {
        ...
        _skillState3 = Animator.StringToHash("Base Layer.AnySub.Skill3");
        _skillWaitState1 = Animator.StringToHash("Base Layer.AnySub.SkillWait1");
        _skillWaitState2 = Animator.StringToHash("Base Layer.AnySub.SkillWait2");
        _skillWaitState3 = Animator.StringToHash("Base Layer.AnySub.SkillWait3");
        _gethitState = Animator.StringToHash("Base Layer.AnySub.GetHit");
        _deadState = Animator.StringToHash("Base Layer.AnySub.Dead");

        Debug.Log(_idleState + " " + _standState + " " + _walkState + " "
            + _runState + " " + _attackState1 + " " + _attackState2
            + _waitState + " " + _skillState1 + " " + _skillState2 
            + " ");
    }
    ...
    protected virtual void SkillState1()
    {

    }
    protected virtual void SkillState2()
    {
    ...
    protected void CallDeadEvent()
    {
        ...
        {
            Debug.Log(_myBossPara.name + " is dead!");
        }
