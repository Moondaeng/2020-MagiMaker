...
public class CBoarFSM : CEnemyFSM
{
    ...
    protected override void InitStat()
    {
        ...
        {
            skillCoolDownDown = 6000f,
            skillCoolDownUp = 8000f
        };
        var S2 = new SetSkillCoolTime
        {
            skillCoolDownDown = 4f,
            skillCoolDownUp = 6f
        };
    ...
    protected override void UpdateState()
    {
        ...
        if (_skillCoolTime[1] < 0f)
        {
            ...
            else
            {
                ...
                _hornPoint = (_hornPoint - transform.position).normalized;
                transform.rotation = Quaternion.LookRotation(_hornPoint);
    ...
    {
        transform.position = Vector3.MoveTowards(transform.position, _walkPoint, _moveSpeed / Time.deltaTime);
    ...
    {
        transform.position = Vector3.MoveTowards(transform.position, _originVector, _moveSpeed / Time.deltaTime);
    ...
    private void SkillState2()
    {
        ...
        Debug.Log(_hornPoint);
        transform.position += _hornPoint * _moveSpeed * Time.deltaTime;
    }
